...
/// <summary>
/// Loads vertex and fragment shader source code using their file paths, also links them both to a shader program and returns it, with checks to see if anything fails
/// </summary>
...
GLuint LoadShaders(const char* vertex_file_path, const char* fragment_file_path)
{
	...
	if (VertexShaderStream.is_open()) /*loads the string as a file into memory*/ {
		...
		std::cout << "Found vertex shader source, opening..." << std::endl;
	}
	else {
		std::cout << "Cannot find or open vertex shader source" << std::endl;
		return 0;
	}
	...
	if (FragmentShaderStream.is_open()) {
		...
		std::cout << "Found fragment shader source, opening..." << std::endl;
	}
	else {
		std::cout << "Cannot find or open fragment shader source" << std::endl;
		return 0;
	}
